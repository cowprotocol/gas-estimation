...
fn estimate_with_limits(response: &Response, time_limit: Duration) -> Result<GasPrice1559> {
    ...
    Ok(GasPrice1559 {
        ...
        max_fee_per_gas: gas_price_in_wei,
        max_priority_fee_per_gas: gas_price_in_wei,
    })
}
